...
Case 1 - OAuth2.0
ケース: grant_type=password（OAuth2.0 パスワードフロー）
...
if __name__ == "__main__":
    ...
    print(f"    python case1_grant_type_password_client.py --username testuser --password password\n")
