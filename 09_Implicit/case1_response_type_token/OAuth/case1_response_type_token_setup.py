#!/usr/bin/env python3
"""
case1_response_type_token_setup.py - Keycloak 初期設定スクリプト

ケース: response_type=token（OAuth2.0 インプリシットフロー）

【処理内容】
  1. Keycloak 起動確認
  2. 管理者トークンの取得
  3. レルム (sample) の作成
  4. クライアント (oauth2-implicit-token) の作成
  5. テストユーザーの作成
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case1_response_type_token_client.py\n")