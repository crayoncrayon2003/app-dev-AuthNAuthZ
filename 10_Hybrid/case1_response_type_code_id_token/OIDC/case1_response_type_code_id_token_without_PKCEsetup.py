#!/usr/bin/env python3
"""
case1_response_type_code_id_token_without_PKCEsetup.py - Keycloak 初期設定スクリプト
...
【実行方法】
  python case1_response_type_code_id_token_without_PKCE_setup.py
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case1_response_type_code_id_token_without_PKCE_client.py\n")