#!/usr/bin/env python3
"""
case2_response_type_code_token_without_PKCE_setup.py - Keycloak 初期設定スクリプト
...
【実行方法】
  python case2_response_type_code_token_without_PKCE_setup.py
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case2_response_type_code_token_without_PKCE_client.py\n")