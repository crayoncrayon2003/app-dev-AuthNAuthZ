#!/usr/bin/env python3
"""
case2_response_type_code_token_without_PKCE_client.py - OIDC ハイブリッドフロー クライアント
...
【実行方法】
  python case2_response_type_code_token_without_PKCE_client.py
...
def main():
    ...
    print(" Case 2 - response_type=code token")
    print("="*60)
