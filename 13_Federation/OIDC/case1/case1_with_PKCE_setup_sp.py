"""
case1_with_PKCE_setup_sp.py - Keycloak SP 初期設定スクリプト
...
【実行順序】
  1. python case1_with_PKCE_setup_idm_idp.py
  2. python case1_with_PKCE_setup_sp.py        ← このスクリプト
  3. python case1_with_PKCE_client.py

【実行方法】
  python case1_with_PKCE_setup_sp.py
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case1_with_PKCE_client.py\n")