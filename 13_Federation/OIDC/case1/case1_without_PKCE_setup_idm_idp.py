"""
case1_without_PKCE_setup_idm_idp.py - Keycloak IdM + IdP 初期設定スクリプト
...
【実行順序】
  1. python case1_without_PKCE_setup_idm_idp.py  ← このスクリプト
  2. python case1_without_PKCE_setup_sp.py
  3. python case1_without_PKCE_client.py

【実行方法】
  python case1_without_PKCE_setup_idm_idp.py
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case1_without_PKCE_setup_sp.py\n")