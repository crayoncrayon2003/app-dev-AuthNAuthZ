#!/usr/bin/env python3
"""
case3_with_PKCE_setup_sp.py - Keycloak SP 初期設定スクリプト
...
【実行順序】
  1. python case3_with_PKCE_setup_idm_ldap.py
  2. python case3_with_PKCE_setup_idp.py
  3. python case3_with_PKCE_setup_sp.py        ← このスクリプト
  4. python case3_with_PKCE_client.py

【実行方法】
  python case3_with_PKCE_setup_sp.py
"""
...
def register_idp_provider(token):
    ...
    if resp.status_code != 200:
        print("  [ERROR] IdP Discovery URL に到達できません。setup_idp.py を先に実行してください。")
        sys.exit(1)
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case3_with_PKCE_client.py\n")