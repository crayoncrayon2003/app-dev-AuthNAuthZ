#!/usr/bin/env python3
"""
case3_without_PKCE_setup_sp.py - Keycloak SP 初期設定スクリプト
...
【実行順序】
  ...
  3. python case3_without_PKCE_setup_sp.py        ← このスクリプト
  4. python case3_without_PKCE_client.py

【実行方法】
  python case3_without_PKCE _setup_sp.py
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case3_without_PKCE_client.py\n")