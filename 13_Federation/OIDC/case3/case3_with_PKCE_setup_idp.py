#!/usr/bin/env python3
"""
case3_with_PKCE_setup_idp.py - Keycloak-IdP 初期設定スクリプト（LDAP連携 + SP向けクライアント）
...
【実行順序】
  ...
  2. python case3_with_PKCE_setup_idp.py  ← このスクリプト
  3. python case3_with_PKCE_setup_sp.py
  4. python case3_with_PKCE_client.py

【実行方法】
  python case3_with_PKCE_setup_idp.py
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case3_with_PKCE_setup_sp.py\n")