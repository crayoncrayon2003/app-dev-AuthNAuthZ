#!/usr/bin/env python3
"""
case2_with_PKCE_setup_idm_ldap.py - OpenLDAP 初期設定スクリプト（IdM）
...
【実行順序】
  1. python case2_with_PKCE_setup_idm_ldap.py  ← このスクリプト
  2. python case2_with_PKCE_setup_idp.py
  3. python case2_with_PKCE_client.py

【実行方法】
  python case2_with_PKCE_setup_idm_ldap.py
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case2_with_PKCE_setup_idp.py\n")