#!/usr/bin/env python3
"""
case2_without_PKCE_setup_idp.py - Keycloak IdP 初期設定スクリプト（OpenLDAP 連携）
...
【実行順序】
  1. python case2_without_PKCE_setup_idm_ldap.py
  2. python case2_without_PKCE_setup_idp.py  ← このスクリプト
  3. python case2_without_PKCE_client.py

【実行方法】
  python case2_without_PKCE_setup_idp.py
"""
...
if __name__ == "__main__":
    ...
    print(f"\n  次のステップ:")
    print(f"    python case2_without_PKCE_client.py\n")